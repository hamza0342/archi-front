...
function Pop_up_Modal_360(props) {
 ...
 const { token }  = isAuthenticated().token;
  const modelData = async () => {
    ...
    // await axios.post(`http://localhost:8080/modelFile/upload/${folderId}`,formdata)
    // .then((res) =>{
    //     console.log(res)
    // })
    await fetch(`http://localhost:8080/tourFile/upload/${folderId}`, {
      method: "POST",
      body: formdata,
...
export default Pop_up_Modal_360;
