...
function Pop_up_newFolder_Mir(props) {
   ...
   // let history = useHistory();
    ...
    const  addFolder = async() => {
        ...
        if (!folderName) {
           ...
           await fetch(`http://localhost:8080/mir/new/${projectId}`,{
                method:"POST",
               body: JSON.stringify({
                   "title":folderName,
               }),
            ...
            >
                <Fade in={open}>
                    <div className={classes.paper}>
                        <h4 style={{ fontWeight: "500", color: "black", }}>Create New Folder In M.I.R</h4>
...
export default Pop_up_newFolder_Mir
